...
module.exports = async (conn, msg, setting) => {  try {
    const { chats, q, from, quotedMsg, mess, isQuotedMsg, mentionUser, getGroupAdmins, isGroupAdmins, prefix, sender, body, isGroup, antilink, args, command, reply } = handler(msg, conn, setting);
